...
import LYRICS from "./as-it-fell-lyrics.json";
...
// ============================================================
//  LYRICS LIBRARY
//  Imported from as-it-fell-lyrics.json (see that file to add/edit ballads).
//  Each key matches the lyricsKey on a quote object.
//  To add a ballad: edit as-it-fell-lyrics.json, then add lyricsKey and
//  stanzaIndex to the relevant quotes in QUOTES above.
// ============================================================
// (LYRICS is imported at the top of this file)
// ============================================================
//  HELPERS
// ============================================================
